...
BEGIN {
    ...
    # TODO make object members. There's no need to have this stuff around as
    # class data. May cause unexpected results if some program is both soap server and client
    my $ns   = 0;
    my $name = 0;
    my $prefix = 'c-';
